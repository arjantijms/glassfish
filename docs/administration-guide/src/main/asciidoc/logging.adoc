...
`https://docs.oracle.com/en/java/javase/21/docs/api/java.logging/java/util/logging/package-summary.html[Java Util Logging Framework]`
or even better it's latest facade
`https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/System.Logger.html[System.Logger]`.
...
`https://docs.oracle.com/en/java/javase/21/docs/api/java.logging/java/util/logging/ConsoleHandler.html[`ConsoleHandler`]`,
...
* `timestampFormat` - see the `https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/time/format/DateTimeFormatter.html[DateTimeFormatter]` documentation.
...
`https://docs.oracle.com/en/java/javase/21/docs/api/java.logging/java/util/logging/SimpleFormatter.html[documentation of the SimpleFormatter class]`
for more.
